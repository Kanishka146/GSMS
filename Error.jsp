...
<title>Error</title>
<link rel="icon" type="image/png" href="img/college.png">
<style type="text/css">
...
<body class="hm-gradient">
	...
	<div align="center">
		...
		<h1 style="color: #ff8c1a;"><font size="8%">Oops! something went wrong</font></h1>
	...
	<h4 align="center">
		<font size="5px" color="black"> <a href="<%=DETView.WELCOME_CTL%>"
